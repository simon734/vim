...
function s:TurnonCursorLine()
    set cursorline
    set cursorcolumn
endfunction
function s:TurnoffCursorLine()
    set nocursorline
    set nocursorcolumn
endfunction
autocmd WinEnter * call s:TurnonCursorLine()
autocmd WinLeave * call s:TurnoffCursorLine()

nnoremap <F6> <C-W>w
nnoremap <S-F6> <C-W>W
inoremap <F6> <Esc><C-W>wi
inoremap <S-F6> <Esc><C-W>Wi
